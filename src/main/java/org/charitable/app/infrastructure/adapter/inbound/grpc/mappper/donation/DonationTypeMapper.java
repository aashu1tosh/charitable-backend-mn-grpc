...
public final class DonationTypeMapper {
    ...
    public static DonationType fromProto(org.charitable.app.proto.DonationType protoStatus) {
        return switch (protoStatus) {
            case BOOKS -> DonationType.BOOKS;
            case CLOTHES -> DonationType.CLOTHES;
            case DONATION_UNSPECIFIED, UNRECOGNIZED -> throw AppException.badRequest("Invalid status: " + protoStatus);
        };
    }
